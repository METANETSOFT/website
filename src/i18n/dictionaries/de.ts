...
export const de: TranslationDict = {
  ...
  cv: {
    ...
    intro: 'Werden Sie Teil unseres Talentpools. Wir arbeiten mit Ingenieuren, Designern und Spezialisten an freiberuflichen, saisonalen und projektbasierten Aufträgen.',
    poolNote: 'Ihr Lebenslauf wird in unserem Pool gespeichert und für passende zukünftige Gelegenheiten geprüft.',
    nameLabel: 'NAME',
    namePlaceholder: 'Ihr Name...',
    emailLabel: 'E-MAIL',
    emailPlaceholder: 'Ihre E-Mail...',
    noteLabel: 'NOTIZ (optional)',
    notePlaceholder: 'Kurze Notiz, bevorzugte Rolle, Verfügbarkeit...',
    fileLabel: 'LEBENSLAUF-DATEI',
    fileHint: 'PDF, DOC oder DOCX — bis zu 8 MB.',
    consent: 'Ich habe die Einwilligung zur Datenverarbeitung gelesen und akzeptiert und stimme zu, dass mein Lebenslauf und die darin enthaltenen personenbezogenen Daten (auch durch KI) zur Talentpool-Zuordnung und Kontaktaufnahme verarbeitet werden dürfen.',
    submit: 'Lebenslauf senden',
    sending: 'Wird gesendet...',
    success: 'Ihr Lebenslauf wurde gesendet. Vielen Dank!',
    error: 'Ihr Lebenslauf konnte nicht gesendet werden. Bitte erneut versuchen.',
  },
};
