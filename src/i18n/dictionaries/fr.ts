...
export const fr: TranslationDict = {
  ...
  cv: {
    sectionIndex: '06 // Vivier de CV',
    title: 'Envoyez-nous votre CV',
    intro: 'Rejoignez notre vivier de talents. Nous collaborons avec des ingénieurs, designers et spécialistes sur des missions freelance, saisonnières et au projet.',
    poolNote: 'Votre CV est conservé dans notre vivier et évalué pour de futures opportunités adaptées.',
    nameLabel: 'NOM',
    namePlaceholder: 'Votre nom...',
    emailLabel: 'E-MAIL',
    emailPlaceholder: 'Votre e-mail...',
    noteLabel: 'NOTE (facultatif)',
    notePlaceholder: 'Une brève note, poste souhaité, disponibilité...',
    fileLabel: 'FICHIER CV',
    fileHint: 'PDF, DOC ou DOCX — jusqu\'à 8 Mo.',
    consent: 'J\'ai lu et j\'accepte le consentement au traitement des données et j\'accepte que mon CV et ses données personnelles soient traités (y compris par IA) pour la mise en relation au sein du vivier et la prise de contact.',
    submit: 'Envoyer le CV',
    sending: 'Envoi...',
    success: 'Votre CV a été envoyé. Merci !',
    error: 'Impossible d\'envoyer votre CV. Veuillez réessayer.',
  },
};
